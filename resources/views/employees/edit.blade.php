    ...
    <div class="py-10 bg-gray-50 min-h-screen">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="text-xl font-black tracking-tight text-gray-900">Edit Employee</h2>
                    <p class="text-xs text-gray-500">Update details for {{ $employee->first_name }} {{ $employee->last_name }}</p>
                </div>
            </div>
